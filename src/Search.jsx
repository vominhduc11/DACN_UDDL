...
const Search = ({ navigation }) => {
    return (
        <View style={{ backgroundColor: '#fff' }}>
            ...
            >
                <IconAntDesign name="left" size={26} onPress={() => navigation.goBack()} />
                ...
                <IconFeather name="shopping-cart" size={26} onPress={() => navigation.navigate('Cart')} />
            </View>
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                >
                    <Text style={{ color: '#000', paddingVertical: 15 }}>Tìm thấy 925 kết quả</Text>
                    {/* phần tử */}
