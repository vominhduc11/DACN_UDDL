          ...
          <View
            ...
            <View
              ...
              <Text style={{color: '#000', marginLeft: 12}}>
                ({formatNumber(product.evaluate)} Đánh giá)
              </Text>
              <Text style={{marginLeft: 18}}>
                {formatNumber(product.booked)} Đã đặt
              </Text>
            </View>
            <TouchableWithoutFeedback>
              <View>
              ...
              <View
                ...
                <Text>
                  <Stars
                    ...
                    disabled={true}
                    fullStar={
                      <IconAntDesign name="star" size={35} color="gold" />
                    }
                    emptyStar={
                      <IconAntDesign name="staro" size={35} color="gold" />
                    }
                    halfStar={
                      <IconFontAwesome5
                        name="star-half-alt"
                    ...
                    <View
                      ...
                      <Text>
                        <Stars
                          ...
                          disabled={true}
                          fullStar={
                            <IconAntDesign name="star" size={14} color="gold" />
                          }
                          emptyStar={
                            <IconAntDesign
                              name="staro"
                ...
                <View
                  ...
                  <Text>
                    <Stars
                      ...
                      emptyStar={
                        <IconAntDesign name="staro" size={14} color="gold" />
                      }
                      halfStar={
                        <IconFontAwesome5
                          name="star-half-alt"
        ...
        <View
          ...
          <View
            ...
            <View
              ...
              <Text style={{color: '#2E8B57', fontWeight: '700'}}>
                Credit +28
              </Text>
              <Text>
          ...
          <View
            ...
            <View style={{paddingHorizontal: 12}}>
              <Text style={{color: '#000', fontWeight: '700', fontSize: 16}}>
                Du thuyền ăn tối cho khách nước ngoài tại bến tàu ICONSIAM (Thời
                gian du thuyền: 20:00 - 22:15)
              </Text>
              <View
                style={{
                  borderWidth: 1,
                  ...
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    ...
                    <TouchableOpacity
                      ...
                      <View
                        ...
                        <Icon name="minus" size={24} color="#b4b4b4" />
                      </View>
                    </TouchableOpacity>
                    ...
                    {/* Nút cộng */}
                    <TouchableOpacity onPress={() => handleChange(count + 1)}>
                      <View
                        style={{
                          backgroundColor: '#f5f5f5',
                          paddingHorizontal: 12,
                        ...
                        <Icon name="plus" size={24} color="#b4b4b4" />
                      </View>
                    </TouchableOpacity>
                  </View>
                </View>
